...
const SERVICE_FEATURE_MATRICES: Record<string, { title: string; rows: MatrixRow[] }> = {
  'web-dev': {
    ...
    rows: [
      ...
      { name: 'Cloud Backend & Authentication', starter: 'Optional Add-on', scale: 'Included', enterprise: 'High-Concurrency Cluster' },
      { name: 'Granular Enterprise Access Security', starter: '—', scale: 'Included', enterprise: 'Enterprise Audit Trail' },
      { name: 'Transactional Email API Integration', starter: 'Included', scale: 'Included', enterprise: 'Custom Email Pipelines' },
  ...
  'ai-automation': {
    ...
    rows: [
      ...
      { name: 'Serverless Edge Functions', starter: 'Basic Logic', scale: 'Advanced Edge Logic', enterprise: 'Custom Python / Deno' },
      { name: 'Transactional Email Triggers', starter: 'Included', scale: 'Included', enterprise: 'Custom Templates & Webhooks' },
