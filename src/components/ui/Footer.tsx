    ...
    <footer className="border-t border-gray-200/80 bg-gray-900 text-white dark:border-dark-border dark:bg-slate-950 font-sans">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <img src={settings?.logoUrl || logo} alt="Logo" className="h-8 w-auto object-contain" />
              <span className="text-xl font-heading font-bold text-white">
                {settings?.footerName || settings?.siteName || 'GM DIGITAL STUDIO'}
              </span>
            </Link>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} {settings?.footerName || settings?.siteName || 'GM DIGITAL STUDIO'}. All rights reserved.
          </p>
